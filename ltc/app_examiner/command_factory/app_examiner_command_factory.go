...
import (
	...
	"github.com/cloudfoundry-incubator/lattice/ltc/app_examiner/command_factory/graphical_visualizer"
...
type AppExaminerCommandFactory struct {
	...
	graphicalVisualizer graphical_visualizer.GraphicalVisualizer
}

func NewAppExaminerCommandFactory(appExaminer app_examiner.AppExaminer, ui terminal.UI, clock clock.Clock, exitHandler exit_handler.ExitHandler, graphicalVisualizer graphical_visualizer.GraphicalVisualizer) *AppExaminerCommandFactory {
